  ...
  renderText = () => {
    return (
      ...
      >
        ...
        >
          <div class="ui centered header">TERMS OF USE</div>
          <div className="ui centered header">Last updated July 02, 2020</div>
          <div class="scrolling content">
            <h2 className="ui header">AGREEMENT TO TERMS</h2>
            <p>
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and Dulce Cultura ("Company", “we”, “us”, or “our”), concerning
              your access to and use of the dulcecultura.com website as well as
              ...
              Site after the date such revised Terms of Use are posted. <br />
              <br />
            ...
            <h2 className="ui header">INTELLECTUAL PROPERTY RIGHTS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">USER REPRESENTATIONS</h2>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">USER REGISTRATION</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">PURCHASES AND PAYMENT</h2>
            <h3 className="ui header">
            ...
            <p>
              ...
              time. All payments shall be in MXN.
              <br />
              <br />
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">RETURN POLICY</h2>
            <p>All sales are final and no refund will be issued.</p>
            <div className="ui divider"></div>
            <h2 className="ui header">PROHIBITED ACTIVITIES</h2>
            <p>
              <div className="text-muted">
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">CONTRIBUTION LICENSE</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">GUIDELINES FOR REVIEWS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">SOCIAL MEDIA</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">SUBMISSIONS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">ADVERTISERS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">SITE MANAGEMENT</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">PRIVACY POLICY</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">COPYRIGHT INFRINGEMENTS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">TERM AND TERMINATION</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">MODIFICATIONS AND INTERRUPTIONS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">GOVERNING LAW</h2>
            <p>
              These terms shall be governed by and defined following the laws of
              Mexico. Dulce Cultura and yourself irrevocably consent that the
              courts of Mexico shall have exclusive jurisdiction to resolve any
              dispute which may arise in connection with these terms.
            </p>
            <div className="ui divider"></div>
            <h2 className="ui header">DISPUTE RESOLUTION</h2>
            <p>
              ...
              of the Mexico courts. Dulce Cultura shall also maintain the right
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">CORRECTIONS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">DISCLAIMER</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">LIMITATIONS OF LIABILITY</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">INDEMNIFICATION</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">USER DATA</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">CALIFORNIA USERS AND RESIDENTS</h2>
            <p>
            ...
            <div className="ui divider"></div>
            <h2 className="ui header">MISCELLANEOUS</h2>
            <p>
            ...
            <br />
            <p>
              Users are subject to a Service fee upon agreeing to the terms and
              conditions. Users information might be shared with third parties
            ...
            <p>
              Dulce Cultura <br />
              Av. Lomas del Rosario <br />
              117 <br />
              San Pedro Garza Garcia, Nuevo Leon 66287 <br />
              Mexico <br />
              Phone: 8110490696 <br />
              infodulcecultura@gmail.com <br />
            </p>
          </div>
        </div>
      </div>
